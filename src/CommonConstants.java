...
public class CommonConstants {
    ...
    public static final Dimension BANNER_SIZE =
            new Dimension(GUI_SIZE.width,50);
    ...
    public static final Dimension ADDTASK_BUTTON_SIZE = new Dimension(
            GUI_SIZE.width,50);

    //task component configs

    public static final Dimension TASKFIELD_SIZE = new Dimension(
            (int)(TASKPANEL_SIZE.width * 0.80), 50);

    public static final Dimension CHECKBOX_SIZE = new Dimension(
